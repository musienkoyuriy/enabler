const { getLineNumberByHTMLSegment, isAngular, isVue, isFunction } = require('./utils');
...
class Validator {
  ...
  _addWarning(el) {
    const message = isFunction(this.warningMessage) ? this.warningMessage(el) : this.warningMessage;
